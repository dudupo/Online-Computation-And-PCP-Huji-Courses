...
& \le \prb{ u,v \text{ s.t } \expp{ \cdot } \ge \delta} \cdot 1 + \prb{ u,v \text{ s.t } \expp{\cdot } \le \delta}  \cdot \delta \\ 
  ...
  \begin{equation*}
    \begin{split}
      ...
      & \le \sum_{|I| \text{is odd} , |I| \le \eta n  }{|\braket{f_{v},\Chi{I} }|^{2}|\braket{f_{ru},\Chi{c^{-1}(I)} }|^{2} \cdot \frac{1}{|I||C^{-1}(I)}} \\ 
      & \le \left(\frac{1}{2} \log_{1-2\varepsilon}\left( \delta^{3} \right)\right)^{-2}\cdot \sum_{|I| \text{is odd} , |I| \le \eta n  }{|\braket{f_{v},\Chi{I} }|^{2}|\braket{f_{ru},\Chi{c^{-1}(I)} }|^{2}} 
    \end{split}
  \end{equation*}
\section{Part 3.}
