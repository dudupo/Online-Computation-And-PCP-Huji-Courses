...
\begin{multicols*}{2}
  ...
  Consider two different polytopes $P,Q \subset \mathbb{R}^{d}$ then we could construct a thired polytop by: 
  \begin{enumerate}
    \item Intersection, takeing the $P\cap Q \subset \mathbb{R}^{d}$
