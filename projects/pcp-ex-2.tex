...
\begin{equation*}
  \begin{split}
    & \sum_{|I| \text{is odd} }{\alpha_{I}^{2}\beta_{C^{-1}(I)}  \left( 1 -2 \varepsilon \right)^{|I|}}  \le \frac{1}{2} \sum_{|I| \text{is odd}, (1-2\varepsilon)^{|I|} < \frac{1}{2}}{\alpha_{I}^{2}\beta_{C^{-1}(I)}}  + \sum_{|I| \text{is odd}, (1-2\varepsilon)^{|I|} \ge \frac{1}{2} }{\alpha_{I}^{2}\beta_{C^{-1}(I)}  \left( 1 -2 \varepsilon \right)^{|I|}}  
   \end{split}
\end{equation*}
...
\begin{equation*}
  \begin{split}
    & \sum_{|I| \in S }{\alpha_{I}^{2}\beta_{C^{-1}(I)}} \le \sum_{|I| \in [n] }{\alpha_{I}^{2}\beta_{C^{-1}(I)}} \le \\ 
    & \frac{1}{2} \left( \sum_{|I| \in S }{\alpha_{I}^{4}} + \sum_{|I| \in S }{\beta_{I}^{2}}   \right) = \frac{1}{2} \left(|f|_{4}^{4} + |g|_{2}^{2} \right) = 1
  \end{split}
\end{equation*} So the inequality become:  

\begin{equation*}
  \begin{split}
    \le \frac{1}{2} +  \sum_{|I| \text{is odd}, (1-2\varepsilon)^{|I|} \ge \frac{1}{2} }{\alpha_{I}^{2}\beta_{C^{-1}(I)}  \left( 1 -2 \varepsilon \right)^{|I|}}  
  \end{split}
\end{equation*}
