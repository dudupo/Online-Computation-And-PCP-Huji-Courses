...
\begin{multicols*}{2}
  ...
  \begin{equation*}
    \begin{split}
      ...
      &  =\sum_{j}{ e^{\eta G_{j,t}  }\left(  1 + \eta g_{j,t+1} \right) }= \psi\left( t \right)  +   \psi\left( t \right) \expp{g_{t+1}}  \\
      & \le \prod_{t}{ \left( 1 +  \expp{g_{t}}\right) }\left( \psi\left( 0 \right) \right) 
    \end{split}
  \end{equation*}
