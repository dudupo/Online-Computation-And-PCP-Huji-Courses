...
%  \end{split}
%\end{equation*}
\paragraph{Soundness.} \ctt{Wrong proof.} Now, assume the second case, namely that any labeling satisfies at most $\mu$ constraints. Also assume through contridiction that there exists an assigment that satisfies more than $\frac{1}{2}+\delta$ equations. Therefore on more than $\frac{1}{4}$ of the tests $f$ pass with probablility at least: $\frac{1}{4}\cdot 1 + \frac{3/4}p   \ge \frac{1}{2} + \delta$ $\Rightarrow p \ge \frac{1}{3} +\frac{4}{3} \delta$. the  at least $1-\mu$ edges there is   
\section{Part 3.}
