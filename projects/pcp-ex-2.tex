...
\begin{equation*}
 ...
 & \le  \frac{1}{2} \sum_{|I| \text{is odd}, (1-2\varepsilon)^{|I|} \ge \frac{1}{4}, \beta_{C^{-1}(I)} \ge 0  }{ \frac{1}{4}\left(|\alpha_{I}|^{2} +  \beta_{C^{-1}(I)}^{2} |\alpha_{I}|^{2}\right) \left( 1 -2 \varepsilon \right)^{|I|}} 
  \end{split}
\end{equation*}<++>
