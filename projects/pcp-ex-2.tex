...
\begin{equation*}
  \begin{split}
    & \sum_{|I| \text{is odd} }{\alpha_{I}^{2}\beta_{C^{-1}(I)}  \left( 1 -2 \varepsilon \right)^{|I|}}  \le \frac{1}{2} + \sum_{|I| \text{is odd}, (1-2\varepsilon)^{|I|} \ge \frac{1}{2} }{\alpha_{I}^{2}\beta_{C^{-1}(I)}  \left( 1 -2 \varepsilon \right)^{|I|}}   
   \end{split}
\end{equation*}
