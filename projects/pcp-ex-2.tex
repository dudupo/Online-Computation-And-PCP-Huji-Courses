...
\begin{equation*}
  \begin{split}
    \le \frac{1}{4} +  \sum_{|I| \text{is odd}, (1-2\varepsilon)^{|I|} \ge \frac{1}{4} }{\alpha_{I}^{2}\beta_{C^{-1}(I)}  \left( 1 -2 \varepsilon \right)^{|I|}}  \le \frac{1}{4} +  \max_{I} \alpha_{I}^{2}\beta_{C^{-1}(I)}  \sum_{|I| \text{is odd}, (1-2\varepsilon)^{|I|} \ge \frac{1}{4} }{|\alpha_{I}|  \left( 1 -2 \varepsilon \right)^{|I|}}
  \end{split}
\end{equation*}
