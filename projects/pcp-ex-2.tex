...
\begin{equation*}
  ...
  \end{split}
\end{equation*}
 Thus in total the inequality of the above section become: 
 \begin{equation*}
   \begin{split}
...
\begin{equation*}
   \begin{split}
     & \left( \sum_{|I| \text{is odd} }{\alpha_{I}^{2}\beta_{C^{-1}(I)}  \left( 1 -2 \varepsilon \right)^{|I|}} \right)^{2} \\ 
     & \le  \sum_{|I| \text{is odd} }{ \alpha_{I}^{2}  } \cdot  \sum_{|I| \text{is odd} }{\alpha_{I}^{2}\beta_{C^{-1}(I)}^{2}  \left( 1 -2 \varepsilon \right)^{2|I|}}
   \end{split}
 \end{equation*}
