...
\begin{multicols*}{2}
  ...
  \begin{equation*}
    ...
    \end{split}
  \end{equation*} Now let $\tilde{\sigma}$ be the uniform distrubtion, and notice that by defintion $\cbase\left( \sigma \right) \le \calg \left( \sigma \right)$. By the fact that probability function must be non negitive we obtain that. 
