...
So it is left to show how one can transform the fractional version into a randomized algorithm that needs to choose either rent or buy. We will flip a coin in each iteration at probability $x$. I do not know how to compute the expected cost, 
%}
