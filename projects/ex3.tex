...
\begin{multicols*}{2}
  ...
  \paragraph{Solution.} Define the potential $\psi\left( t \right) =  \sum_{j}{ e^{\eta G_{i,t}}}$ and notice that: 

  \begin{equation*}
    \begin{split}
      & \psi\left( t + 1 \right) =  \sum_{j}{ e^{\eta G_{j,t+1}}} =\sum_{j}{ e^{\eta G_{j,t} + \eta g_{j,t+1}}}  \\
      & \Rightarrow   \psi\left( t \right) \ge \psi\left( t + 1 \right)\le \psi\left( t \right)e^{\eta}
    \end{split}
  \end{equation*}
