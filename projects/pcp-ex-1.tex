...
\begin{equation*}
  ...
  \end{split}
\end{equation*}
\caption{ Illustration of the equations system. The left system is a vadermonde matrix in which the $((x,y),(i,j))$ entry corresponds to $x^{i}y^{j}$ where $(x,y)$ are one of the points in $\FF_{q}^{2}$.}
\end{figure}
