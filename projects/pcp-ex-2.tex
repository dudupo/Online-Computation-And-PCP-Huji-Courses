...
\paragraph{Soundness.} Suppose that $\varphi \not{\in} \text{E3-CNF-SAT}$, Thus for any $x \in \mathbb{F}_{2}^{*}$ no more than $\mu$ closures are satisfied. Assume throawds contradiction that more than $\mu^{\prime}= \frac{1}{6}\mu$ of the restriction are satisfied.      
