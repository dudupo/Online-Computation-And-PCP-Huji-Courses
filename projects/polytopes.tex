...
\begin{multicols*}{2}
  ...
  \lemma{ For $ S \subset T = \left\{ y_{1} .. y_{n}  \right\}$ such that $|S|=d$ form a facet if and only if any two different item of $T/S$ are different by an even number of items from $S$.}
